...
class Role(db.Model):
    ...
    def insert_roles():
        roles = {
            'User':[Permission.FOLLOW,Permission.COMMENT,Permission.WRITE_ARTICLE],
            'Moderator':[Permission.FOLLOW,Permission.COMMENT,Permission.MODERATE_COMMENTS],
            'Administrator':[Permission.FOLLOW,Permission.COMMENT,Permission.WRITE_ARTICLE,Permission.MODERATE_COMMENTS,Permission.ADMINISTER]
        }
        default_role = 'User'
        for r in roles:
    ...
    def has_permissions(self,perm):
        return self.permission and perm == perm
